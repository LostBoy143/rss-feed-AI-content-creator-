...
const TextArea = () => {
  ...
  return (
    <div className="sticky top-0 p-8 h-screen m-auto w-full gap-2 max-w-fit lg:w-1/2 rounded-sm flex-5 flex-col dark:bg-gray-900 dark:border-gray-700">
      ...
      <textarea
        className="bg-gray-800 h-[75vh] p-2 rounded-sm "
        value={state.content}
        onChange={(e) =>
          dispatch({
            type: "SET_DATA",
